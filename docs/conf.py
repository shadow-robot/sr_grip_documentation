...
latex_documents = [
    (master_doc, 'GRIPFramework.tex', u'Grasping Robot Integration and Prototyping (GRIP) Documentation',
...
man_pages = [
    (master_doc, 'GRIPFramework', u'Grasping Robot Integration and Prototyping (GRIP) Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'GRIPFramework', u'Grasping Robot Integration and Prototyping (GRIP) Documentation',
     author, 'GRIPFramework', 'One line description of project.',
     'Miscellaneous'),
]
